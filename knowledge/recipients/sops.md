...
## sop/SOP-AIOPS-017-multi-user-authz-contract

**Kind:** sop
**Axis:** capability
**When to use:** Standard Operating Procedure SOP-AIOPS-017-multi-user-authz-contract

**Invoke:** Triggered by event subscriptions, or `Read("06-ai-ops/sops/SOP-AIOPS-017-multi-user-authz-contract/flow.yaml")`
**HITL tier:** C
**Side effect:** write
...
## sop/SOP-AIOPS-018-video-runtime-contract

**Kind:** sop
**Axis:** capability
**When to use:** Standard Operating Procedure SOP-AIOPS-018-video-runtime-contract

**Invoke:** Triggered by event subscriptions, or `Read("06-ai-ops/sops/SOP-AIOPS-018-video-runtime-contract/flow.yaml")`
**HITL tier:** A
**Side effect:** none
...
## sop/SOP-AIOPS-019-prompt-runtime-contract

**Kind:** sop
**Axis:** capability
**When to use:** Standard Operating Procedure SOP-AIOPS-019-prompt-runtime-contract

**Invoke:** Triggered by event subscriptions, or `Read("06-ai-ops/sops/SOP-AIOPS-019-prompt-runtime-contract/flow.yaml")`
**HITL tier:** A
**Side effect:** none
