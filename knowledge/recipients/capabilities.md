...
**Kind:** capability
**Axis:** meta
**When to use:** Data Visualization (McKinsey-caliber charts, like /image for data→chart). A general, reused-many-times data-visualization capability — the /dataviz v0.2.0
