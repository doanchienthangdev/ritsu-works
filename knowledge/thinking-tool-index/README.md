...
> The "load fast, select precisely, no context-lost" structure. Unifies **374 toolkit frameworks** + **207 book frameworks** = 581 tools, split by 4S step, plus **19 domain processes**.
...
## Files
- `frame.md · structure.md · solve.md · sell.md · cross.md` — per-4S-step tool maps (frame=36 · structure=105 · solve=258 · sell=77 · cross=85).
- `processes.md` — the domain-process router (19 playbooks).
