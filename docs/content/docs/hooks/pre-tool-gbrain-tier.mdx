---
title: 'Hook: pre-tool-gbrain-tier'
description: pre-tool hook
source_path: .claude/hooks/pre-tool-gbrain-tier.md
source_hash: eba28bb248c0425bfb74cf7353469a0abffdb47cf2f0a31c135b8e5912489ed7
generated_at: '2026-07-14T15:59:15.692Z'
