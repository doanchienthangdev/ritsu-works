...
title: 'Skill: mm'
description: >
  The /mm deep-monograph writer — turn the NAME of ANY subject (a mental model, concept, idea,
  theory,

  model, system, algorithm, framework, principle, phenomenon… anything worth understanding deeply)
  into
...
source_path: 06-ai-ops/skills/mm/SKILL.md
source_hash: cd7e1addf5a67e4f390c73c83c2232cd004ba5ed77dfac7b1922cd3381b1b425
generated_at: '2026-07-14T15:59:15.569Z'
