...
description: >-
  ...
  (v1.3) where they make the point — OR an honest no-coverage gap + remedy. Internal-first (web leg
  delegated to deep-research). Tier A runtime (Tier-B+ legs surfaced, never auto-run).
source_path: .claude/commands/deepask.md
source_hash: 7f9e1f0378394a1a74472d6fbadb29dff8e55c1f340b46cec94eeec08a7d4b1c
generated_at: '2026-06-05T03:26:20.190Z'
