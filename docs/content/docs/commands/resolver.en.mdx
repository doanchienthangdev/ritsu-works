---
title: 'Command: /resolver (v2.2)'
description: >-
  Lookup PLATFORM v2 (LLM-Native Catalog) — find AI workforce recipients for natural-language
  triggers. v2 uses in-session ambient catalog (Mode A, preferred), explicit LLM query (Mode B,
  audit), or keyword fallback (Mode C, CRON only). Catalog auto-loaded via
  @knowledge/recipients/*.md.
source_path: .claude/commands/resolver.md
source_hash: 3cd6bab71f0f1d6f02bac966a616b44263005b36477fdb81d0e5c61f7cb47ca8
generated_at: '2026-05-24T13:05:13.758Z'
