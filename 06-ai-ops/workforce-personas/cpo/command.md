# CPO slash command — compiled output for `.claude/commands/cpo.md`

Copy block below verbatim into `.claude/commands/cpo.md`.
...
Same as agent.md plus: multi-turn keywords (`session`, `push back`, `dialog`) present.
