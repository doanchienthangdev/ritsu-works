...
const CHAPTER_ORDER = [
  ...
  "phase-a2/49-capability-case-dataviz.md",
  ...
  "phase-a2/56-tutorial-local-install-platform.md",
  "phase-a2/57-capability-case-mental-models.md",
  "A1-glossary.md",
  "A2-references.md",
  "A3-pr-templates.md",
];
...
const SIDEBAR_SEGMENTS = [
  ...
  // ch49 = dataviz case study #15 (added 2026-06-04); tutorials shifted to 50/51.
  ["---Phần VI — Capability Case Studies---", "---Part VI — Capability Case Studies---", (s) => /^(3[4-9]|4[0-9])-/.test(s)],
  // Part VII = Tutorials (instructional how-it-works chapters, distinct from the
  // retrospective case studies). ch50 = /think mckinsey engine; ch51 = product-db; 52-59 reserved.
  ["---Phần VII — Tutorials---", "---Part VII — Tutorials---", (s) => /^(5\d)-/.test(s)],
