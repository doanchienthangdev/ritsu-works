...
description: |
  ...
  **thinking-toolkit** capability (v1.2.0). Routes to 11 McKinsey/Minto-derived
...
capability (v1.2.0). Capability spec at `wiki/capabilities/thinking-toolkit/spec.md`.

The command is a **thin orchestrator**. All thinking discipline lives in the 11
...
```
/think — McKinsey/Minto thinking discipline (11 skills, capability v1.2.0)
...
Canonical: `wiki/capabilities/thinking-toolkit/spec.md` (v1.2.0).
