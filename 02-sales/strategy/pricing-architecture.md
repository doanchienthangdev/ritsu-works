...
|---|---|---|---|
| **1** | **Free 5-sessions-per-project cap** | The multi-week-path job *structurally* exceeds 5 sessions on the one project that matters | `[observed · Door-2: 7/32 (~22% of projects-with-sessions, 26%) ≥5 sessions; max 547; avg ~24 (median 3)]` |
...
| **A2** | Ladder center of gravity = **Free→Plus wall = the 5-session cap** | It is the fence the paying-core job (multi-week path) crashes into first, observed in Door-2 (7 of 32 projects, ~22%) | `[observed-grounded; gaps UNPROVEN]` |
